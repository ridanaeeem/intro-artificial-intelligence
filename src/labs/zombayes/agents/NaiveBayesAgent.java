    ...
    extends SurvivalAgent
{
        ...
        extends Object
    {
        ...
        double f1HumanSTDEV = 0;
        // standard deviation of feature 1 for zombies
        double f1ZombieSTDEV = 0;
        ...
        double f2HumanSTDEV = 0;
        // standard deviation of feature 2 for zombies
        double f2ZombieSTDEV = 0;
        ...
        public void fit(Matrix X, Matrix y_gt)
        {
            ...
            f1HumanSTDEV = (f1HumanStdDev / totalHumans);
            f1HumanStdDev = Math.pow((f1HumanStdDev / totalHumans),0.5);
            f1ZombieSTDEV = (f1ZombieStdDev / totalZombies);
            f1ZombieStdDev =  Math.pow((f1ZombieStdDev / totalZombies),0.5);
            ...
            f2HumanSTDEV = (f2HumanStdDev / totalHumans);
            f2HumanStdDev = Math.pow((f2HumanStdDev / totalHumans),0.5);
            f2ZombieSTDEV = (f2ZombieStdDev / totalZombies);
        ...
        public int predict(Matrix x)
        {
            ...
            // gaussian
            f1HumanProb = Math.exp(-Math.pow(f1 - f1HumanMean, 2) / (2 * f1HumanSTDEV)) / (Math.sqrt(2 * Math.PI * f1HumanSTDEV));
            f1ZombieProb = Math.exp(-Math.pow(f1 - f1ZombieMean, 2) / (2 * f1ZombieSTDEV)) / (Math.sqrt(2 * Math.PI * f1ZombieSTDEV));
            f2HumanProb = Math.exp(-Math.pow(f2 - f2HumanMean, 2) / (2 * f2HumanSTDEV)) / (Math.sqrt(2 * Math.PI * f2HumanSTDEV));
            f2ZombieProb = Math.exp(-Math.pow(f2 - f2ZombieMean, 2) / (2 * f2ZombieSTDEV)) / (Math.sqrt(2 * Math.PI * f2ZombieSTDEV));

            // System.out.println("f1HumanProb " + f1HumanProb);
            // System.out.println("f1ZombieProb " + f1ZombieProb);
            // System.out.println("f2HumanProb " + f2HumanProb);
            // System.out.println("f2ZombieProb " + f2ZombieProb);

            // System.out.println("f1HumanSTDEV " + f1HumanSTDEV);
            // System.out.println("f1ZombieSTDEV " + f1ZombieSTDEV);
            // System.out.println("f2HumanSTDEV " + f2HumanSTDEV);
            // System.out.println("f2ZombieSTDEV " + f2ZombieSTDEV);
            
            // f1HumanProb = -Math.log(f1HumanProb);
            // f1ZombieProb = -Math.log(f1ZombieProb);
            // f2HumanProb = -Math.log(f2HumanProb);
            // f2ZombieProb = -Math.log(f2ZombieProb);

            // if (f1HumanProb < 0 || f1HumanProb > 1) {
            //     f1HumanProb = .0001;
            // } else {
            //     f1HumanProb = f1HumanMean - f1HumanProb;
            // }
            // if (f1ZombieProb < 0 || f1ZombieProb > 1) {
            //     f1ZombieProb = .0001;
            // } 
            // if (f2HumanProb < 0 || f2HumanProb > 1) {
            //     f2HumanProb = .0001;
            // } 
            // if (f2ZombieProb < 0 || f2ZombieProb > 1) {
            //     f2ZombieProb = .0001;
            // }
